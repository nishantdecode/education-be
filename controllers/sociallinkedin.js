...
passport.use(new LinkedInStrategy({
  ...
  callbackURL: 'http://localhost:3000/api/auth/social/linkedin/callback',
...
app.get('/', passport.authenticate('linkedin'));

// Callback route after successful authentication
app.get('/callback', passport.authenticate('linkedin', { failureRedirect: '/login' }),
  async (req, res) => {
