...
const createAdd = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ message: "Error creating advertisement", error: error.message });
  }
};
...
const getAdvertisementByTitle = async (req, res) => {
  try {
    ...
    res
      .status(200)
      .json({ message: "Advertisement retrieved successfully", advertisement });
  } catch (error) {
...
const updateAdvertisement = async (req, res) => {
  ...
  try {
    ...
    res
      .status(200)
      .json({ message: "Advertisement updated successfully", advertisement });
  } catch (error) {
    res
      .status(500)
      .json({ message: "Error updating advertisement", error: error.message });
  }
};
