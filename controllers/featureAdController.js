...
const create = async (req, res) => {
  try {
    ...
    res
      .status(201)
      .json({ message: "FeatureAd created successfully", featureAd });
  } catch (error) {
    res
      .status(500)
      .json({ message: "Error creating featureAd", error: error.message });
  }
};
...
const getAllFeatureAds = async (req, res) => {
  try {
    ...
    res
      .status(200)
      .json({ message: "All featureAds retrieved successfully", featureAds });
  } catch (error) {
    res
      .status(500)
      .json({ message: "Error retrieving featureAds", error: error.message });
  }
};
...
const getFeatureAdById = async (req, res) => {
  ...
  try {
    ...
    res
      .status(200)
      .json({ message: "FeatureAd retrieved successfully", featureAd });
  } catch (error) {
    res
      .status(500)
      .json({ message: "Error retrieving featureAd", error: error.message });
  }
};
...
const updateFeatureAd = async (req, res) => {
  ...
  try {
    ...
    res
      .status(200)
      .json({ message: "FeatureAd updated successfully", featureAd });
  } catch (error) {
    res
      .status(500)
      .json({ message: "Error updating featureAd", error: error.message });
  }
};
...
const deleteFeatureAd = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ message: "Error deleting featureAd", error: error.message });
  }
};
