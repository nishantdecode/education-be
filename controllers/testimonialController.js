...
const getAllTestimonials = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Error retrieving testimonials", error: error.message });
  }
};
...
const getTestimonialById = async (req, res) => {
  ...
  try {
    ...
    res
      .status(200)
      .json({ message: "Testimonial retrieved successfully", testimonial });
  } catch (error) {
    res
      .status(500)
      .json({ message: "Error retrieving testimonial", error: error.message });
  }
};
